"""URL Access Profile configuration service for Strata Cloud Manager SDK.

Provides service class for managing URL access profile objects via the SCM API.
"""

# scm/config/security/url_access_profile.py
...
class URLAccessProfile(BaseObject):
    """Manages URL Access Profile objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    def create(
        ...
        return URLAccessProfileResponseModel(**response)
    ...
    def update(
        self,
        profile: URLAccessProfileUpdateModel,
    ) -> URLAccessProfileResponseModel:
        """Update an existing URL access profile object.

        Args:
            profile: URLAccessProfileUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        profiles: List[URLAccessProfileResponseModel],
        filters: Dict[str, Any],
    ) -> List[URLAccessProfileResponseModel]:
        """Apply client-side filtering to the list of URL access profiles.

        Args:
            profiles: List of URLAccessProfileResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[URLAccessProfileResponseModel]: Filtered list of profiles
    ...
    def list(
        ...
        **filters,
        ...
        """List URL access profile objects with optional filtering.
        ...
        Args:
            ...
            **filters: Additional filters (none currently supported)
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [URLAccessProfileResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single URL access profile by name.

        Args:
            name (str): The name of the URL access profile to fetch.
    ...
    def delete(
        ...
        """Delete a URL access profile object.
