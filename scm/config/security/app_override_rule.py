"""App Override Rule configuration service for Strata Cloud Manager SDK.

Provides service class for managing app override rule objects via the SCM API.
"""

# scm/config/security/app_override_rule.py
...
class AppOverrideRule(BaseObject):
    """Manages App Override Rule objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    def create(
        ...
        if not isinstance(rulebase, AppOverrideRuleRulebase):
            try:
                rulebase = AppOverrideRuleRulebase(rulebase.lower())
            except ValueError:
                raise InvalidObjectError(
        ...
        profile = AppOverrideRuleCreateModel(**data)
        ...
        return AppOverrideRuleResponseModel(**response)
    ...
    def get(
        ...
        if not isinstance(rulebase, AppOverrideRuleRulebase):
            try:
                AppOverrideRuleRulebase(rulebase.lower())
            except ValueError:
                raise InvalidObjectError(
                    message="rulebase must be either 'pre' or 'post'",
                    error_code="E003",
    ...
    def update(
        self,
        rule: AppOverrideRuleUpdateModel,
        rulebase: str = "pre",
    ) -> AppOverrideRuleResponseModel:
        """Update an existing app override rule object.

        Args:
            rule: AppOverrideRuleUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        rules: List[AppOverrideRuleResponseModel],
        filters: Dict[str, Any],
    ) -> List[AppOverrideRuleResponseModel]:
        """Apply client-side filtering to the list of app override rules.

        Args:
            rules: List of AppOverrideRuleResponseModel objects
        ...
        if "application" in filters:
            ...
            filter_criteria = [rule for rule in filter_criteria if rule.application in applications]
        ...
        if "protocol" in filters:
            ...
            filter_criteria = [rule for rule in filter_criteria if rule.protocol in protocols]
    ...
    def list(
        ...
        **filters,
        ...
        """List app override rule objects with optional filtering.
        ...
        Args:
            ...
            **filters: Additional filters including:
                ...
                - protocol: List[str] - Filter by protocols
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [AppOverrideRuleResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single app override rule by name.

        Args:
            name (str): The name of the app override rule to fetch.
    ...
    def delete(
        ...
        """Delete an app override rule object.
    ...
    def move(
        ...
        """Move an app override rule to a new position within the rulebase.
        ...
        move_config = AppOverrideRuleMoveModel(**data)
