"""Decryption Rule configuration service for Strata Cloud Manager SDK.

Provides service class for managing decryption rule objects via the SCM API.
"""

# scm/config/security/decryption_rule.py
...
class DecryptionRule(BaseObject):
    """Manages Decryption Rule objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    def create(
        ...
        if not isinstance(rulebase, DecryptionRuleRulebase):
            try:
                rulebase = DecryptionRuleRulebase(rulebase.lower())
            except ValueError:
                raise InvalidObjectError(
        ...
        profile = DecryptionRuleCreateModel(**data)
        ...
        return DecryptionRuleResponseModel(**response)
    ...
    def get(
        ...
        if not isinstance(rulebase, DecryptionRuleRulebase):
            try:
                DecryptionRuleRulebase(rulebase.lower())
            except ValueError:
                raise InvalidObjectError(
                    message="rulebase must be either 'pre' or 'post'",
                    error_code="E003",
    ...
    def update(
        self,
        rule: DecryptionRuleUpdateModel,
        rulebase: str = "pre",
    ) -> DecryptionRuleResponseModel:
        """Update an existing decryption rule object.

        Args:
            rule: DecryptionRuleUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        rules: List[DecryptionRuleResponseModel],
        filters: Dict[str, Any],
    ) -> List[DecryptionRuleResponseModel]:
        """Apply client-side filtering to the list of decryption rules.

        Args:
            rules: List of DecryptionRuleResponseModel objects
    ...
    def list(
        ...
        **filters,
        ...
        """List decryption rule objects with optional filtering.
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [DecryptionRuleResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single decryption rule by name.

        Args:
            name (str): The name of the decryption rule to fetch.
    ...
    def delete(
        ...
        """Delete a decryption rule object.
    ...
    def move(
        ...
        """Move a decryption rule to a new position within the rulebase.
        ...
        move_config = DecryptionRuleMoveModel(**data)
