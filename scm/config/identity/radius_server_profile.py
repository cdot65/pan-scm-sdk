"""RADIUS Server Profile configuration service for Strata Cloud Manager SDK.

Provides service class for managing RADIUS server profile objects via the SCM API.
"""

# scm/config/identity/radius_server_profile.py
...
class RadiusServerProfile(BaseObject):
    """Manages RADIUS Server Profile objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    def create(
        ...
        return RadiusServerProfileResponseModel(**response)
    ...
    def update(
        self,
        profile: RadiusServerProfileUpdateModel,
    ) -> RadiusServerProfileResponseModel:
        """Update an existing RADIUS server profile object.

        Args:
            profile: RadiusServerProfileUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        profiles: List[RadiusServerProfileResponseModel],
        filters: Dict[str, Any],
    ) -> List[RadiusServerProfileResponseModel]:
        """Apply client-side filtering to the list of RADIUS server profiles.

        Args:
            profiles: List of RadiusServerProfileResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[RadiusServerProfileResponseModel]: Filtered list of profiles
    ...
    def list(
        ...
        **filters,
        ...
        """List RADIUS server profile objects with optional filtering.
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [RadiusServerProfileResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single RADIUS server profile by name.

        Args:
            name (str): The name of the RADIUS server profile to fetch.
    ...
    def delete(
        ...
        """Delete a RADIUS server profile object.
