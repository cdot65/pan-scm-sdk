"""Certificate Profile configuration service for Strata Cloud Manager SDK.

Provides service class for managing certificate profile objects via the SCM API.
"""

# scm/config/identity/certificate_profile.py
...
class CertificateProfile(BaseObject):
    """Manages Certificate Profile objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    ENDPOINT = "/config/identity/v1/certificate-profiles"
    ...
    def __init__(
        ...
        """Initialize the CertificateProfile service with the given API client."""
    ...
    def create(
        ...
        """Create a new certificate profile object.
        ...
        profile = CertificateProfileCreateModel(**data)
        ...
        return CertificateProfileResponseModel(**response)

    def get(
        self,
        object_id: str,
    ) -> CertificateProfileResponseModel:
        """Get a certificate profile object by ID.
    ...
    def update(
        self,
        profile: CertificateProfileUpdateModel,
    ) -> CertificateProfileResponseModel:
        """Update an existing certificate profile object.

        Args:
            profile: CertificateProfileUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        profiles: List[CertificateProfileResponseModel],
        filters: Dict[str, Any],
    ) -> List[CertificateProfileResponseModel]:
        """Apply client-side filtering to the list of certificate profiles.

        Args:
            profiles: List of CertificateProfileResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[CertificateProfileResponseModel]: Filtered list of profiles
    ...
    def list(
        ...
        **filters,
        ...
        """List certificate profile objects with optional filtering.
        ...
        Returns:
            List[CertificateProfileResponseModel]: A list of certificate profile objects
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [CertificateProfileResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single certificate profile by name.

        Args:
            name (str): The name of the certificate profile to fetch.
            folder (str, optional): The folder in which the resource is defined.
            snippet (str, optional): The snippet in which the resource is defined.
            device (str, optional): The device in which the resource is defined.

        Returns:
            CertificateProfileResponseModel: The fetched certificate profile object as a Pydantic model.
    ...
    def delete(
        ...
        """Delete a certificate profile object.
