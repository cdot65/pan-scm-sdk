"""TLS Service Profile configuration service for Strata Cloud Manager SDK.

Provides service class for managing TLS service profile objects via the SCM API.
"""

# scm/config/identity/tls_service_profile.py
...
class TlsServiceProfile(BaseObject):
    """Manages TLS Service Profile objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    ENDPOINT = "/config/identity/v1/tls-service-profiles"
    ...
    def __init__(
        ...
        """Initialize the TlsServiceProfile service with the given API client."""
    ...
    def create(
        ...
        """Create a new TLS service profile object.
        ...
        profile = TlsServiceProfileCreateModel(**data)
        ...
        return TlsServiceProfileResponseModel(**response)

    def get(
        self,
        object_id: str,
    ) -> TlsServiceProfileResponseModel:
        """Get a TLS service profile object by ID.
    ...
    def update(
        self,
        profile: TlsServiceProfileUpdateModel,
    ) -> TlsServiceProfileResponseModel:
        """Update an existing TLS service profile object.

        Args:
            profile: TlsServiceProfileUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        profiles: List[TlsServiceProfileResponseModel],
        filters: Dict[str, Any],
    ) -> List[TlsServiceProfileResponseModel]:
        """Apply client-side filtering to the list of TLS service profiles.

        Args:
            profiles: List of TlsServiceProfileResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[TlsServiceProfileResponseModel]: Filtered list of profiles
    ...
    def list(
        ...
        **filters,
        ...
        """List TLS service profile objects with optional filtering.
        ...
        Returns:
            List[TlsServiceProfileResponseModel]: A list of TLS service profile objects
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [TlsServiceProfileResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single TLS service profile by name.

        Args:
            name (str): The name of the TLS service profile to fetch.
            folder (str, optional): The folder in which the resource is defined.
            snippet (str, optional): The snippet in which the resource is defined.
            device (str, optional): The device in which the resource is defined.

        Returns:
            TlsServiceProfileResponseModel: The fetched TLS service profile object as a Pydantic model.
    ...
    def delete(
        ...
        """Delete a TLS service profile object.
