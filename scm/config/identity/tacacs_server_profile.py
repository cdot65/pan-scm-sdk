"""TACACS+ Server Profile configuration service for Strata Cloud Manager SDK.

Provides service class for managing TACACS+ server profile objects via the SCM API.
"""

# scm/config/identity/tacacs_server_profile.py
...
class TacacsServerProfile(BaseObject):
    """Manages TACACS+ Server Profile objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    ENDPOINT = "/config/identity/v1/tacacs-server-profiles"
    ...
    def create(
        ...
        return TacacsServerProfileResponseModel(**response)
    ...
    def update(
        self,
        profile: TacacsServerProfileUpdateModel,
    ) -> TacacsServerProfileResponseModel:
        """Update an existing TACACS+ server profile object.

        Args:
            profile: TacacsServerProfileUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        profiles: List[TacacsServerProfileResponseModel],
        filters: Dict[str, Any],
    ) -> List[TacacsServerProfileResponseModel]:
        """Apply client-side filtering to the list of TACACS+ server profiles.

        Args:
            profiles: List of TacacsServerProfileResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[TacacsServerProfileResponseModel]: Filtered list of profiles
    ...
    def list(
        ...
        **filters,
        ...
        """List TACACS+ server profile objects with optional filtering.
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [TacacsServerProfileResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single TACACS+ server profile by name.

        Args:
            name (str): The name of the TACACS+ server profile to fetch.
    ...
    def delete(
        ...
        """Delete a TACACS+ server profile object.
