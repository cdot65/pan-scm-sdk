"""Authentication Profile configuration service for Strata Cloud Manager SDK.

Provides service class for managing authentication profile objects via the SCM API.
"""

# scm/config/identity/authentication_profile.py
...
class AuthenticationProfile(BaseObject):
    """Manages Authentication Profile objects in Palo Alto Networks' Strata Cloud Manager.
    ...
    def create(
        ...
        return AuthenticationProfileResponseModel(**response)
    ...
    def update(
        self,
        profile: AuthenticationProfileUpdateModel,
    ) -> AuthenticationProfileResponseModel:
        """Update an existing authentication profile object.

        Args:
            profile: AuthenticationProfileUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        profiles: List[AuthenticationProfileResponseModel],
        filters: Dict[str, Any],
    ) -> List[AuthenticationProfileResponseModel]:
        """Apply client-side filtering to the list of authentication profiles.

        Args:
            profiles: List of AuthenticationProfileResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[AuthenticationProfileResponseModel]: Filtered list of profiles
    ...
    def list(
        ...
        **filters,
        ...
        """List authentication profile objects with optional filtering.
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [AuthenticationProfileResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        """Fetch a single authentication profile by name.

        Args:
            name (str): The name of the authentication profile to fetch.
    ...
    def delete(
        ...
        """Delete an authentication profile object.
