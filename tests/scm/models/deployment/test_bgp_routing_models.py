...
class TestBackboneRoutingEnum:
    ...
    def test_enum_values(self):
        ...
        assert BackboneRoutingEnum.ASYMMETRIC_ROUTING_WITH_LOAD_SHARE == "asymmetric-routing-with-load-share"
...
class TestBGPRoutingBaseModel:
    ...
    def test_field_validator_different_classes(self):
        ...
        create_model = BGPRoutingCreateModel(backbone_routing=BackboneRoutingEnum.NO_ASYMMETRIC_ROUTING, 
        ...
        update_model = BGPRoutingUpdateModel(backbone_routing=BackboneRoutingEnum.NO_ASYMMETRIC_ROUTING, 
                                             outbound_routes_for_services=None)
...
class TestBGPRoutingCreateModel:
    ...
    def test_validate_routing_preference_with_invalid_type(self):
        ...
        assert str(exc_info.value) == "routing_preference must be either DefaultRoutingModel or HotPotatoRoutingModel"
...
class TestBGPRoutingUpdateModel:
    ...
    def test_validate_update_model_with_invalid_routing_preference(self):
        ...
        assert "routing_preference must be either DefaultRoutingModel or HotPotatoRoutingModel" in str(exc_info.value)
