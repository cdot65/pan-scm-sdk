...
from scm.exceptions import (ActionNotSupportedError, APIError,
                            APINotImplementedError, AuthenticationError,
                            AuthorizationError, BadRequestError, BadXPathError,
                            ClientError, ConflictError, ErrorHandler,
                            ErrorResponse, GatewayTimeoutError,
                            InputFormatMismatchError, InvalidCommandError,
                            InvalidCredentialError, InvalidObjectError,
                            InvalidQueryParameterError, KeyExpiredError,
                            KeyTooLongError, MalformedCommandError,
                            MethodAPINotSupportedError, MethodNotAllowedError,
                            MissingBodyError, MissingQueryParameterError,
                            NameNotUniqueError, NotAuthenticatedError,
                            NotFoundError, ObjectNotPresentError,
                            ObjectNotUniqueError, OutputFormatMismatchError,
                            PasswordChangeRequiredError, ReferenceNotZeroError,
                            ServerError, SessionTimeoutError,
                            UnauthorizedError, VersionAPINotSupportedError)
