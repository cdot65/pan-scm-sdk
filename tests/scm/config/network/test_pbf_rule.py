...
class TestPbfRule(TestPbfRuleBase):
    ...
    def test_list_with_exact_match(self, sample_pbf_rule_dict):
        """Test list with exact_match filtering."""
        other = sample_pbf_rule_dict.copy()
        other["id"] = str(uuid.uuid4())
        other["folder"] = "Other Folder"
        self.mock_scm.get.return_value = {
            "data": [sample_pbf_rule_dict, other],
            "offset": 0,
            "total": 2,
            "limit": 200,
        }
    ...
    def test_list_with_exclude_folders(self, sample_pbf_rule_dict):
    ...
    def test_list_with_exclude_snippets(self, sample_pbf_rule_dict):
        """Test list with exclude_snippets filtering."""
        item = sample_pbf_rule_dict.copy()
    ...
    def test_list_with_exclude_devices(self, sample_pbf_rule_dict):
