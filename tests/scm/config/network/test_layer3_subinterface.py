...
class TestLayer3Subinterface(TestLayer3SubinterfaceBase):
    ...
    def test_init_with_negative_max_limit(self):
        ...
        with pytest.raises(InvalidObjectError) as excinfo:
            Layer3Subinterface(self.mock_scm, max_limit=-1)
    ...
    def test_list_filtering_invalid_tag(self, sample_layer3_dict):
        """Test list method with invalid tag filter type."""
        self.mock_scm.get.return_value = {
            "data": [sample_layer3_dict],
            "limit": 20,
            "offset": 0,
            "total": 1,
        }
        with pytest.raises(InvalidObjectError) as excinfo:
            self.client.list(folder="Test Folder", tag="not-an-int")
        assert "Invalid Object" in str(excinfo.value)

    def test_list_filtering_by_parent_interface(self, sample_layer3_dict):
    ...
    def test_list_filtering_invalid_parent_interface(self, sample_layer3_dict):
    ...
    def test_list_filtering_invalid_mtu(self, sample_layer3_dict):
    ...
    def test_list_pagination(self, sample_layer3_dict):
    ...
    def test_list_with_exact_match(self, sample_layer3_dict):
    ...
    def test_list_with_exclude_folders(self, sample_layer3_dict):
    ...
    def test_list_with_exclude_snippets(self, sample_layer3_dict):
    ...
    def test_list_with_exclude_devices(self, sample_layer3_dict):
    ...
    def test_fetch_with_data_array_format(self, sample_layer3_dict):
    ...
    def test_fetch_with_empty_data_array(self):
        ...
        with pytest.raises(InvalidObjectError) as excinfo:
            self.client.fetch(name="ethernet1/1.100", folder="Test Folder")
        assert "No matching layer3 subinterface found" in str(excinfo.value)
    ...
    def test_fetch_with_multiple_results(self, sample_layer3_dict, monkeypatch):
        ...
        assert "Multiple layer3 subinterfaces found" in mock_warning.call_args[0][0]
