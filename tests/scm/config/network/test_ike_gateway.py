...
class TestIKEGateway(TestIKEGatewayBase):
    ...
    def test_list_with_pagination(self):
        ...
        second_response = {"data": [mock_gateway_3], "limit": 2, "offset": 2, "total": 3}
    ...
    def test_list_with_exclude_folders(self):
        ...
        result = self.client.list(device="test-device", exclude_folders=["folder-2"])
    ...
    def test_list_with_exclude_snippets(self):
        ...
        result = self.client.list(device="test-device", exclude_snippets=["snippet-2"])
    ...
    def test_list_with_exclude_devices(self):
        ...
        result = self.client.list(folder="test-folder", exclude_devices=["device-2"])
    ...
    def test_fetch_multiple_containers(self):
        ...
        with pytest.raises(InvalidObjectError) as exc_info:
            self.client.fetch(name="test-gateway", folder="test-folder", snippet="test-snippet")
