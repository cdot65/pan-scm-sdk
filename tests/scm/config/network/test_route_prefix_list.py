...
class TestRoutePrefixList(TestRoutePrefixListBase):
    ...
    def test_create(self, sample_route_prefix_list_dict):
        """Test create method."""
        self.mock_scm.post.return_value = sample_route_prefix_list_dict

        # Create a copy without the ID for create operation
        create_data = sample_route_prefix_list_dict.copy()
        create_data.pop("id")
