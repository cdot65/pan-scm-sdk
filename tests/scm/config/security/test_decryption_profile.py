...
from scm.models.security.decryption_profiles import (
    DecryptionProfileResponseModel, SSLVersion)
from tests.factories import (DecryptionProfileCreateApiFactory,
                             DecryptionProfileResponseFactory,
                             DecryptionProfileUpdateApiFactory,
                             SSLForwardProxyFactory, SSLInboundProxyFactory,
...
class TestDecryptionProfileUpdate(TestDecryptionProfileBase):
    ...
    def test_update_valid_object(self):
        ...
        # Check endpoint
        assert call_args[0][0] == f"/config/security/v1/decryption-profiles/{update_data.id}"
