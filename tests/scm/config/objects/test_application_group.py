...
from tests.factories import (ApplicationGroupCreateApiFactory,
...
class TestApplicationGroupList(TestApplicationGroupBase):
    ...
    def test_list_filters_types(self):
        ...
        assert error_response["_errors"][0]["message"] == "'members' filter must be a list"
...
class TestApplicationGroupUpdate(TestApplicationGroupBase):
    ...
    def test_update_valid_object(self):
        ...
        # Check endpoint
        assert call_args[0][0] == f"/config/objects/v1/application-groups/{update_data.id}"
