...
# Local SDK imports (absolute imports only)
...
class <Resource>(BaseObject):
    ...
    def create(
        ...
        resource = <Resource>CreateModel(**data)

        # Convert back to a Python dictionary, removing any unset fields
        # Note: exclude_unset=True is critical for SCM API compatibility
        ...
        return <Resource>ResponseModel(**response)
    ...
    def update(
        ...
        # Note: exclude_unset=True ensures only explicitly set fields are sent
        payload = resource.model_dump(exclude_unset=True)
    ...
    @staticmethod
    def _apply_filters(
        resources: List[<Resource>ResponseModel],
        filters: Dict[str, Any],
    ) -> List[<Resource>ResponseModel]:
        """Apply client-side filtering to the list of resources.
        ...
        Returns:
            List[<Resource>ResponseModel]: Filtered list of resources
        ...
        if "tags" in filters:
            ...
            filter_criteria = [
                res
                for res in filter_criteria
                if res.tag and any(tag in res.tag for tag in tags)
            ]

        # Add additional filter logic specific to the resource type
    ...
    def list(
        ...
        **filters,
        ...
        """List <resource> objects with optional filtering.
        ...
        Returns:
            List[<Resource>ResponseModel]: A list of <resource> objects
        ...
        while True:
            ...
            data = response["data"]
            object_instances = [<Resource>ResponseModel(**item) for item in data]
    ...
    def fetch(
        ...
        Args:
            name (str): The name of the <resource> to fetch.
            folder (str, optional): The folder in which the resource is defined.
            snippet (str, optional): The snippet in which the resource is defined.
            device (str, optional): The device in which the resource is defined.

        Returns:
            <Resource>ResponseModel: The fetched <resource> object as a Pydantic model.
    ...
    def delete(
        ...
        try:
            ...
            self.logger.error(f"Error deleting <resource> with ID {object_id}: {str(e)}")
            raise